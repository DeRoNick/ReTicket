...
using ReTicket.MVC.Data;

namespace ReTicket.MVC.Controllers
{
    public class TicketListingsController : Controller
    {
        private readonly ReTicketMVCContext _context;

        public TicketListingsController(ReTicketMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketId,EventId,UserId,Price")] TicketListing ticketListing)
        {
